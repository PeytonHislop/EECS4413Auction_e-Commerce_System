...
public class IamClient {
    ...
    public IamClient(RestClient restClient, DownstreamProperties props) {
        this.restClient = restClient;
        this.baseUrl = props.iam().baseUrl();
    }
    ...
    public ResponseEntity<String> postWithAuth(String path, String authHeader) {
        try {
            String body = restClient.post()
                    .uri(baseUrl + path)
